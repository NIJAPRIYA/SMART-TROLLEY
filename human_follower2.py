...
import sys
sys.path.insert(0, '/home/pi/myopencv_project/myopencv/lib/python3.9/site-packages')
import common as cm
import cv2
import numpy as np
...
import sys
sys.path.insert(0, '/home/pi/myopencv_project/myopencv/lib/python3.9/site-packages/human_following')
import util as ut
ut.init_gpio()
...
def move_robot():
    ...
    distance = ut.get_distance()
    print("Current Distance:", distance, "cm")

    # Stop if we are within 30 cm of the person
    if distance <= 30:
        
        ut.stop()
        print("Reached target distance from human.")
    else:
        
        
        # Adjust movement based on x_deviation
